...
export class ScriptureService {
  ...
  private sanitizeListQuery = (query: scriptureListQueryType) => {
    ...
    const allowedSortFields = ["createdAt", "updatedAt", "author", "title", "mode", "timeOfDay"];
    ...
    const sanitized: scriptureListQueryType = {
      page,
      limit,
      sort,
    };
    ...
    const filterFields: Array<keyof scriptureListQueryType> = [
      "author",
      "title",
      "mode",
      "timeOfDay",
  ...
  getAllScriptures = async (query: scriptureListQueryType) => {
